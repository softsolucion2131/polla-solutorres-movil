...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Turf Bet — Apuestas hípicas" },
      { name: "description", content: "Plataforma de apuestas hípicas: administra tu banca, hipódromos, agencias y jugadas en un solo lugar." },
      { property: "og:title", content: "Turf Bet — Apuestas hípicas" },
      { property: "og:description", content: "Administra tu banca, hipódromos, agencias y jugadas en un solo lugar." },
